...
<style>
	...
	<body>
		...
		?>
		<div class = "crud">		
				<form   class = "lcrud" method = post accept-charset="UTF-8" action = "pesquisa_deleta_cliente.php">
					<p style = "font-family: tech; color: white; font-size: 20px;">Remover cliente</p>
				...
				<form   class = "ccrud" method = post accept-charset="UTF-8" action = "pesquisa_deleta_funcionario.php">
					<p style = "font-family: tech; color: white; font-size: 20px;">Remover funcionário</p>
				...
				<form   class = "rcrud" method = post accept-charset="UTF-8" action = "pesquisa_deleta_fornecedor.php">
					<p style = "font-family: tech; color: white; font-size: 20px;">Remover fornecedor</p>
